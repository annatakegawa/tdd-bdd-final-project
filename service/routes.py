...
def get_products(product_id):
    ...
    app.logger.info(f"Product with id {product_id} found.")
...
def update_products(product_id):
    """
    Update a Product
    This endpoint will update a Product based on the posted body
    """
...
def delete_products(product_id):
    """
    Delete a product
    This endpoint will delete a Product based on the given id
    """
